...
\begin{tikzpicture}
	...
	child[concept color = blue!30!teal] {
		...
		node[concept] {Clase abstracte} [clockwise from=90] 
			child[concept color = blue!30!teal]{
				node[concept]{Specificatori de acces}[clockwise from = 180] {child{node[concept]{public}}}
				node[concept]{Specificatori de acces}[clockwise from = 135] {child{node[concept]{private}}}
				node[concept]{Specificatori de acces}[clockwise from = 90] {child{node[concept]{protected}}}
